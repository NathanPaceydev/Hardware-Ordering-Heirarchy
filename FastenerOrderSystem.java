...
// Given Main Class to run the order system**
public class FastenerOrderSystem {

    private static ArrayList<Fasteners> db;
    ...
    private static void readDB() {
        ...
        try (ObjectInputStream binFileIn = new ObjectInputStream(new FileInputStream(inputFile))) {
            ...
            db = (ArrayList<Fasteners>)binFileIn.readObject();
    ...
    private static int getFastenerChoice(Class<? extends Fasteners> classChoice) {
    ...
    public static void main(String[] args) {
        ...
        int partNum;
        String cost;
        Class<? extends Fasteners> classChoice;
        readDB();
